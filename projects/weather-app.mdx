...
<video src="https://cdn.jsdelivr.net/gh/fabian-kleine/project-showcases/weather-app_background.mp4" height={800} width={800} controls muted playsInline className="rounded-xl mx-auto my-4"></video>
