...
<Video title="Background Gradient Animation" video="https://cdn.jsdelivr.net/gh/fabian-kleine/project-showcases/weather-app_background.mp4" height={800} width={800} controls muted playsInline className="mx-auto my-4" />
